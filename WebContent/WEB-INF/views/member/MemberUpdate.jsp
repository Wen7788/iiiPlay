    ...
    <br>
        ...
        <input type="hidden" name="finalDecision" value="" > 
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="password" name="password" class="form-control" id="password"  value="${MemberBean.password}" >
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" name="name" class="form-control" id="name"  value="${MemberBean.name}${param.name}">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" name="email" class="form-control" id="email"  value="${MemberBean.email}${param.email}">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" name="age" class="form-control" id="age"  value="${MemberBean.age}${param.age}">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <label>
                        <input type="checkbox" name="games" value="LOL" id="gameLOL"  >LOL
                    </label>
                    <label>
                        <input type="checkbox" name="games" value="PUBG" id="gamePUBG">PUBG
                    </label>
                    <label>
                        <input type="checkbox" name="games" value="CSGO" id="gameCSGO">CSGO
                    </label>
                </div>
                <br>
                <br>
                ...
                <button type="submit" class="btn btn-primary" onclick="confirmUpdate()">確定修改</button>

                <button type="submit" class="btn btn-danger" onclick="confirmDelete()">刪除帳號</button>
                </div>
